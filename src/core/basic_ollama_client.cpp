...
BasicOllamaClient::BasicOllamaClient(const std::string& host) : mHost(host) {
...
GenerateOptions::ModelParams BasicOllamaClient::merge_model_params(
    GenerateOptions::ModelParams params,
...
std::string BasicOllamaClient::model_params_to_json(
...
GenerateResult BasicOllamaClient::generate(
...
EmbedResult BasicOllamaClient::embed(
...
BasicOllamaClient::HttpResult BasicOllamaClient::post_json(
